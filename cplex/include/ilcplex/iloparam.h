...
struct Param {
  ...
  struct Read {
    ...
    static const IloCplex::BoolParam DataCheck = BoolParam(CPX_PARAM_DATACHECK);
  ...
  static const IloCplex::IntParam SolutionTarget = IntParam(CPX_PARAM_SOLUTIONTARGET);
